...
SCRIPT="user_identification/jobs/slurm_train_triplet_4s_fold_resume.slurm"

for fold in 1 2 3 4; do
  RUN_DIR="final_user_identification_triplet/4s/fold_${fold}"
  mkdir -p "${RUN_DIR}"
  ...
  sbatch \
    ...
    --job-name="triplet_4s_f${fold}_resume" \
