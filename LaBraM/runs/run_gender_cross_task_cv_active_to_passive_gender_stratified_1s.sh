#!/bin/bash
# LaBraM Fine-tuning Script for gender_cross_task_cv_active_to_passive_gender_stratified (1s segments)
...
DATASET="gender_cross_task_cv_active_to_passive_gender_stratified"
NB_CLASSES=1
...
echo "=========================================="
echo "LaBraM Fine-tuning for gender_cross_task_cv_active_to_passive_gender_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for gender_cross_task_cv_active_to_passive_gender_stratified"
