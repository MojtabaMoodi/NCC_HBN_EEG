#!/bin/bash
# LaBraM Fine-tuning Script for age_cross_task_cv_active_to_passive_age_stratified (4s segments)
...
DATASET="age_cross_task_cv_active_to_passive_age_stratified"
NB_CLASSES=3
...
echo "=========================================="
echo "LaBraM Fine-tuning for age_cross_task_cv_active_to_passive_age_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for age_cross_task_cv_active_to_passive_age_stratified"
