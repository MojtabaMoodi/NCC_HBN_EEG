#!/bin/bash
# LaBraM Fine-tuning Script for combined_cross_task_active_to_passive (4s segments)
...
DATASET="combined_cross_task_active_to_passive"
NB_CLASSES=6
...
echo "=========================================="
echo "LaBraM Fine-tuning for combined_cross_task_active_to_passive"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for combined_cross_task_active_to_passive"
