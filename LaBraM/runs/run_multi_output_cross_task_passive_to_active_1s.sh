#!/bin/bash
# LaBraM Fine-tuning Script for multi_output_cross_task_passive_to_active (1s segments)
...
DATASET="multi_output_cross_task_passive_to_active"
NB_CLASSES=2
...
echo "=========================================="
echo "LaBraM Fine-tuning for multi_output_cross_task_passive_to_active"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for multi_output_cross_task_passive_to_active"
