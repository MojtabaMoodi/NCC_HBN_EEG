#!/bin/bash
# LaBraM Fine-tuning Script for combined_cv_combined_stratified (4s segments)
...
DATASET="combined_cv_combined_stratified"
NB_CLASSES=6
...
echo "=========================================="
echo "LaBraM Fine-tuning for combined_cv_combined_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for combined_cv_combined_stratified"
