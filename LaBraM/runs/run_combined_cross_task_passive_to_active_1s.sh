#!/bin/bash
# LaBraM Fine-tuning Script for combined_cross_task_passive_to_active (1s segments)
...
DATASET="combined_cross_task_passive_to_active"
NB_CLASSES=6
...
echo "=========================================="
echo "LaBraM Fine-tuning for combined_cross_task_passive_to_active"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for combined_cross_task_passive_to_active"
