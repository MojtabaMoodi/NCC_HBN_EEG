#!/bin/bash
# LaBraM Fine-tuning Script for multi_output_cv_gender_stratified (1s segments)
...
DATASET="multi_output_cv_gender_stratified"
NB_CLASSES=2
...
echo "=========================================="
echo "LaBraM Fine-tuning for multi_output_cv_gender_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for multi_output_cv_gender_stratified"
