#!/bin/bash
# LaBraM Fine-tuning Script for combined_cross_task_cv_passive_to_active_combined_stratified (4s segments)
...
DATASET="combined_cross_task_cv_passive_to_active_combined_stratified"
NB_CLASSES=6
...
echo "=========================================="
echo "LaBraM Fine-tuning for combined_cross_task_cv_passive_to_active_combined_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for combined_cross_task_cv_passive_to_active_combined_stratified"
