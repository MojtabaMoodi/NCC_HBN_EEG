#!/bin/bash
# LaBraM Fine-tuning Script for gender_cross_task_passive_to_active (4s segments)
...
DATASET="gender_cross_task_passive_to_active"
NB_CLASSES=1
...
echo "=========================================="
echo "LaBraM Fine-tuning for gender_cross_task_passive_to_active"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for gender_cross_task_passive_to_active"
