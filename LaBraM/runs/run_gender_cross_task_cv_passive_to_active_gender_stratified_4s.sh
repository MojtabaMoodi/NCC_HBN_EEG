#!/bin/bash
# LaBraM Fine-tuning Script for gender_cross_task_cv_passive_to_active_gender_stratified (4s segments)
...
DATASET="gender_cross_task_cv_passive_to_active_gender_stratified"
NB_CLASSES=1
...
echo "=========================================="
echo "LaBraM Fine-tuning for gender_cross_task_cv_passive_to_active_gender_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for gender_cross_task_cv_passive_to_active_gender_stratified"
