#!/bin/bash
# LaBraM Fine-tuning Script for age_cross_task_passive_to_active (4s segments)
...
DATASET="age_cross_task_passive_to_active"
NB_CLASSES=3
...
echo "=========================================="
echo "LaBraM Fine-tuning for age_cross_task_passive_to_active"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for age_cross_task_passive_to_active"
