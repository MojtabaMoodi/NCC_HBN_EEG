#!/bin/bash
# LaBraM Fine-tuning Script for multi_output_cross_task_active_to_passive (4s segments)
...
DATASET="multi_output_cross_task_active_to_passive"
NB_CLASSES=2
...
echo "=========================================="
echo "LaBraM Fine-tuning for multi_output_cross_task_active_to_passive"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for multi_output_cross_task_active_to_passive"
