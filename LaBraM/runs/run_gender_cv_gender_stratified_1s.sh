#!/bin/bash
# LaBraM Fine-tuning Script for gender_cv_gender_stratified (1s segments)
...
DATASET="gender_cv_gender_stratified"
NB_CLASSES=1
...
echo "=========================================="
echo "LaBraM Fine-tuning for gender_cv_gender_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for gender_cv_gender_stratified"
