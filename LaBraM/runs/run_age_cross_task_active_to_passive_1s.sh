#!/bin/bash
# LaBraM Fine-tuning Script for age_cross_task_active_to_passive (1s segments)
...
DATASET="age_cross_task_active_to_passive"
NB_CLASSES=3
...
echo "=========================================="
echo "LaBraM Fine-tuning for age_cross_task_active_to_passive"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for age_cross_task_active_to_passive"
