#!/bin/bash
# LaBraM Fine-tuning Script for age_cv_age_stratified (1s segments)
...
echo "=========================================="
echo "LaBraM Fine-tuning for age_cv_age_stratified"
echo "=========================================="
...
echo "=========================================="
echo "Fine-tuning completed for age_cv_age_stratified"
